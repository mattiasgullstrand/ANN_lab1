...
class DeepBeliefNet():
    ...
    def generate(self,true_lbl,name):
        ...
        vis = np.random.randint(0,2,size=(n_samples,self.sizes["pen"]))
        ...
        for iter in range(self.n_gibbs_gener):
            ...
            img_gen = self.rbm_stack['hid--pen'].get_v_given_h_dir(img_gen)[0] #one down
            img_gen = self.rbm_stack['vis--hid'].get_v_given_h_dir(img_gen)[0] #another down
    ...
    def train_greedylayerwise(self, vis_trainset, lbl_trainset, n_iterations):
        ...
        try :
            ...
            hid_trainset = rbm.get_h_given_v(vis_trainset)[0]
            ...
            top_trainset = np.concatenate((rbm.get_h_given_v(hid_trainset)[0], lbl_trainset), axis=1)
    ...
    def train_wakesleep_finetune(self, vis_trainset, lbl_trainset, n_iterations):
        ...
        try :
            ...
            self.loadfromfile_dbn(loc="trained_dbn",name="pen+lbl--top")
            ...
            for it in range(n_iterations):
                ...
                y_1 = rbmB.get_h_given_v_dir(y_0)[1]
                ...
                y_P = rbmB.get_v_given_h_dir(y_1)[0]
                rbmB.update_generate_params(y_0, y_1, y_P)

                y_P = rbmH.get_v_given_h_dir(y_2)[0]
                rbmH.update_generate_params(y_1, y_2, y_P)
                ...
                y_P = rbmH.get_h_given_v_dir(z_1)[0]
                rbmH.update_recognize_params(z_2, z_1, y_P)

                y_P = rbmB.get_h_given_v_dir(z_0)[0]
                rbmB.update_recognize_params(z_1, z_0, y_P)
            ...
            self.savetofile_dbn(loc="trained_dbn",name="pen+lbl--top")
